// declaro el prompt para poder ingresar datos por consola
...
function agregarLibro (id, titulo, autor, anio, genero){
    //Agrego un nuevo objeto y le indico con el push que lo ponga al final de la lista de libros.
    let nuevoLibro = {
        "id": id,
        "titulo": titulo, 
        "Autor" : autor, 
    ...
    libros.push(nuevoLibro); //pusheo el nuevo libro al array libros.
